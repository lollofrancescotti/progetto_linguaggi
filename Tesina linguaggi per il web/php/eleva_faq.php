...
<label class="titolo" for="domanda">Testo Domanda</label>
<input class="input" type="text" name="domanda" value="<?php echo $testo_domanda?>"><br>
<label class="titolo" for="risposta">Testo Risposta</label>
<input class="input" type="text" name="risposta" value="<?php echo $testo_risposta ?>">
...
<?php
    ...
    <input class="input" type="text" name="domanda" value="<?php echo $testo_domanda?>"><br>
    <label class="titolo" for="risposta">Testo Risposta</label>
    <input class="input" type="text" name="risposta">
    <button class="btn" type="submit" name="vota">Aggiungi FAQ</button>
    </form>
    </td>
            </tr>
